<?php
include_once('maincon.php');
$maincon = new mainconn();
echo "me";
...
var testdata;
jQuery.getJSON("http://v5.com/abc/player/selectsong?symbol=rUBy&jsoncallback=?", 
function(data) {
  testdata = data;
   ...
   $("#jquery_jplayer").jPlayer({
		ready: function () {
			k=0;
			playTrack(testdata[k]['mp3'],testdata[k]['name']);
		},
		customCssIds: true
	})
...
<div id="demo">
	<ul>
		...
		<li><a href="#" id="theseparation">The Separation</a></li>
		<li> | </li>
		<li><a href="#" id="lismore">Lismore</a></li>
		<li> | </li>
		<li><a href="#" id="thinice">Thin Ice</a></li>
	</ul>
	<p>Now playing : <span id="trackname">nothing</span> <span class="pcent" id="pcent"></span></p>
	<ul>
